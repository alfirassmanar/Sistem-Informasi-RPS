...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Tambah Pembelajaran</h1>
            </div>
        </div><!--/.row-->

        <h3 style="margin-bottom: 20px;">Tambah Pembelajaran</h3>
        <form action="../../././../controller/admin/prosesTambah_Pembelajaran.php" method="post">
            <?php
            ...
            ?>
                <div class="form-group">
                    ...
                    <select class="form-control" id="namaMahasiswa" name="idMahasiswa" required style="font-size: 12px;">
                        <option value="" disabled selected>-- Pilih Mahasiswa --</option>
                        <?php
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<option value='" . $row['idMahasiswa'] . "'>" . $row['namaMahasiswa'] . "</option>";
                        }
                        ?>
                    </select>
                </div>
            ...
            ?>
                <div class="form-group">
                    ...
                    <select class="form-control" id="kodeMK" name="kodeMK" required style="font-size: 12px;">
