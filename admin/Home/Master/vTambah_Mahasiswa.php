...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <form action="../../././../controller/admin/prosesTambah_Mahasiswa.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="nama" style="font-size: 12px;">Nama Mahasiswa :</label>
                <input type="text" class="form-control" id="nama" name="namaMahasiswa" required style="font-size: 12px;">
            </div>
            <div class="form-group">
                <label for="nama" style="font-size: 12px;">Tahun Masuk :</label>
                <input type="text" class="form-control" id="nama" name="tahunMasuk" required style="font-size: 12px;">
            </div>
            <div class="form-group">
                <label for="nama" style="font-size: 12px;">No.Telp :</label>
                <input type="text" class="form-control" id="nama" name="noTelpMahasiswa" required style="font-size: 12px;">
            </div>
            <div class="form-group">
                <label for="nama" style="font-size: 12px;">Email :</label>
                <input type="text" class="form-control" id="nama" name="emailMahasiswa" required style="font-size: 12px;">
            </div>
            <div class="form-group">
                <label for="nama" style="font-size: 12px;">Password :</label>
                <input type="text" class="form-control" id="nama" name="passwordMahasiswa" required style="font-size: 12px;">
            </div>
            <div class="form-group">
                <label for="nama" style="font-size: 12px;">Bukti Aktif 1 :</label>
                <input type="file" class="form-control" id="nama" name="buktiAktif_pertama" required style="font-size: 12px;">
            </div>
            <div class="form-group">
                <label for="nama" style="font-size: 12px;">Bukti Aktif 2 :</label>
                <input type="file" class="form-control" id="nama" name="buktiAktif_kedua" required style="font-size: 12px;">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="jenjang" name="jenisIdentitas" style="font-size: 12px;" readonly required>
            </div>
