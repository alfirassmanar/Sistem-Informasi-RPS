...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <form action="../../././../controller/admin/prosesTambah_MataKuliah.php" method="post" enctype="multipart/form-data">
            <?php
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="namaMK" name="namaMK" required style="font-size: 12px;">
            </div>
            <div class="form-group">
