...
$sql = "SELECT * FROM tbl_jurusan WHERE idJurusan = $idJurusan";
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    $idFakultas = $jurusan['idFakultas'];
    $programStudi = $jurusan['programStudi'];
...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <h3 style="margin-bottom: 20px;">Ubah Jurusan</h3>
        <form action="../../././../controller/admin/prosesUbah_Jurusan.php?idJurusan=<?= $idJurusan; ?>" method="post">
            <div class="form-group">
                <label for="nama" style="font-size: 12px;">Nama/ID Fakultas :</label>
                <input type="text" class="form-control" id="nama" name="idFakultas" value="<?= $idFakultas ?>" required style="font-size: 12px;" readonly>
            </div>
            <div class="form-group">
                <label for="nama" style="font-size: 12px;">Program Studi :</label>
                <input type="text" class="form-control" id="nama" name="programStudi" value="<?= $programStudi ?>" required style="font-size: 12px;" readonly>
            </div>
            <div class="form-group">
                <label for="nama" style="font-size: 12px;">Jenjang :</label>
                <input type="text" class="form-control" id="nama" name="jenjang" value="<?= $jenjang ?>" required style="font-size: 12px;" placeholder="D3" readonly>
            </div>
            <div class="form-group">
