...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <h3 style="margin-bottom: 20px;">Tambah Jurusan</h3>
        <form action="../../././../controller/admin/prosesTambah_Jurusan.php" method="post">
            <div class="form-group">
                <label for="idFakultas" style="font-size: 12px;">Nama Fakultas :</label>
                <select class="form-control" id="idFakultas" name="idFakultas" required style="font-size: 12px;">
                    <option value="" disabled selected>-- Pilih Fakultas --</option>
                    <?php
                    include '../../../database/koneksi.php';
                    // Query untuk mendapatkan data dari tabel tbl_fakultas
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                        ...
                        echo "<option disabled>Tidak ada data fakultas.</option>";
                    }
                    ?>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama" name="programStudi" required style="font-size: 12px;">
            </div>
            <div class="form-group">
                <label for="nama" style="font-size: 12px;">Jenjang :</label>
                <input type="text" class="form-control" id="nama" name="jenjang" required style="font-size: 12px;" placeholder="D3">
            </div>
            <div class="form-group">
