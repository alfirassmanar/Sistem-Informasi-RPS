...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Tambah Fakultas</h1>
            </div>
        </div><!--/.row-->

        <h3 style="margin-bottom: 20px;">Tambah Fakultas</h3>
        <form action="../../././../controller/admin/prosesTambah_Fakultas.php" method="post">
            <div class="form-group">
                <label for="nama" style="font-size: 12px;">Nama Fakultas :</label>
                <input type="text" class="form-control" id="nama" name="namaFakultas" required style="font-size: 12px;">
            </div>
