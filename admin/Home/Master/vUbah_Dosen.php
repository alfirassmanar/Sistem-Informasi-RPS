...
$sql = "SELECT * FROM tbl_dosen WHERE idDosen = $idDosen";
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    $gelarDosen = $dosen['gelarDosen'];
    $jenisIdentitas = $dosen['jenisIdentitas'];
    $nomorIdentitas = $dosen['nomorIdentitas'];
    $noTelpDosen = $dosen['noTelpDosen'];
    $emailDosen = $dosen['emailDosen'];
    $passwordDosen = $dosen['passwordDosen'];
    $instansiDosen = $dosen['instansiDosen'];
...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Halaman Ubah Dosen</h1>
            </div>
        </div><!--/.row-->

        <form action="../../../controller/admin/prosesUbah_Dosen.php?idDosen=<?= $idDosen; ?>" method="post">
            <div class="form-group">
                <label for="nama" style="font-size: 12px;">Nama Dosen :</label>
                <input type="text" class="form-control" id="nama" name="namaDosen" value="<?php echo $namaDosen; ?>" required style="font-size: 12px;">
            </div>
            <div class="form-group">
                <label for="nama" style="font-size: 12px;">Gelar Dosen :</label>
                <input type="text" class="form-control" id="nama" name="gelarDosen" value="<?php echo $gelarDosen; ?>" required style="font-size: 12px;">
            </div>
            <div class="form-group">
                ...
                <select class="form-control" id="status" name="jenisIdentitas" required style="font-size: 12px;">
                    <option value="" disabled selected>-- <?= $jenisIdentitas ?> --</option>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama" name="nomorIdentitas" required style="font-size: 12px;" value="<?= $nomorIdentitas ?>">
            </div>
            <div class="form-group">
                <label for="noTelp" style="font-size: 12px;">No. Telepon :</label>
                <input type="number" class="form-control" id="noTelp" name="noTelpDosen" required style="font-size: 12px;" value="<?= $noTelpDosen ?>">
            </div>
            <div class="form-group">
                <label for="email" style="font-size: 12px;">Email :</label>
                <input type="email" class="form-control" id="email" name="emailDosen" required style="font-size: 12px;" value="<?= $emailDosen ?>">
            </div>
            <div class="form-group">
                <label for="password" style="font-size: 12px;">Password :</label>
                <input type="text" class="form-control" id="password" name="passwordDosen" required style="font-size: 12px;" value="<?= $passwordDosen ?>">
            </div>
            <div class="form-group">
                <label for="password" style="font-size: 12px;">Instansi :</label>
                <input type="text" class="form-control" id="instansiDosen" name="instansiDosen" required style="font-size: 12px;" value="<?= $instansiDosen ?>">
            </div>
            <div class="form-group">
                ...
                <select class="form-control" id="programStudi" name="programStudi" required style="font-size: 12px;">
                    <option value="" disabled selected>-- <?= $programStudi ?> --</option>
                    <?php
                    include '../../././../database/koneksi.php';
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="status" name="status" required style="font-size: 12px;">
                    ...
                    <option value="null">non Aktif</option>
                </select>
            </div>
