...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Halaman Fakultas</h1>
                <div class="text-left">
                    <a href="./Master/vTambah_Pembelajaran.php">
        ...
        <div class="panel panel-container">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    $sql = "SELECT pb.*, m.namaMahasiswa
                            FROM tbl_pembelajaran pb
                            INNER JOIN tbl_mahasiswa m ON pb.idMahasiswa = m.idMahasiswa";
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<tr>";
                            echo "<td>" . $no++ . "</td>";
                            echo "<td>" . $row['namaMahasiswa'] . "</td>"; // Menampilkan namaMahasiswa dari tbl_mahasiswa
                            echo "<td>" . $row['kodeMK'] . "</td>";

                            echo "<td>";
                            echo "<a href='./Master/vUbah_Pembelajaran.php?idPembelajaran=" . $row['idPembelajaran'] . "'><button class='btn btn-primary'>Ubah</button></a>";
                            echo "<a href='../../controller/admin/prosesHapus_Pembelajaran.php?idPembelajaran=" . $row['idPembelajaran'] . "'><button class='btn btn-danger'>Hapus</button></a>";
                            echo "</td>";
                            echo "</tr>";
                        }
                    } else {
