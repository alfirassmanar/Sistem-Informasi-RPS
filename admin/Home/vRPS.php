...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Halaman RPS</h1>
                <div class="text-left">
                    <a href="./Master/vTambah_RPS.php">
        ...
        <div class="panel panel-container">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    $sql = "SELECT r.idRPS, m.namaMK, r.rps 
                            FROM tbl_rps r
                            INNER JOIN tbl_mk m ON r.idMK = m.idMK";
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td>";
                            echo "<a href='./Master/vUbah_RPS.php?idRPS=" . $row['idRPS'] . "'><button class='btn btn-primary'>Ubah</button></a>";
                            echo "<a href='../../controller/admin/prosesHapus_RPS.php?idRPS=" . $row['idRPS'] . "'><button class='btn btn-danger'>Hapus</button></a>";
                            echo "</td>";
                            echo "</tr>";
                        }
                    } else {
                        echo "<tr><td colspan='4'>Tidak ada data RPS.</td></tr>";
                    }
                    ?>
