...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Halaman Jurusan</h1>
                <div class="text-left">
                    <a href="./Master/vTambah_Jurusan.php">
                ...
                <tbody>
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td>";
                            echo "<a href='./Master/vUbah_Jurusan.php?idJurusan=" . $row['idJurusan'] . "'><button class='btn btn-primary'>Ubah</button></a>";
                            echo "<a href='../../controller/admin/prosesHapus_Jurusan.php?idJurusan=" . $row['idJurusan'] . "'><button class='btn btn-danger'>Hapus</button></a>";
                            echo "</td>";
                            echo "</tr>";
                        }
                    } else {
