...
<body>
    <div class="login-container">
        <div style="text-align: center;">
            ...
            <div>
                <span style="font-size: 14px; font-family: 'Times New Roman', Times, serif; color: #555;">Masuk ke Sistem SIRPS.id</span>
            </div>
        </div>
        <br>
        ...
        <div class="container" style="text-align: center;">
            <label style="font-size: 14px; font-family: 'Times New Roman', Times, serif; color: #555;">Belum memiliki akun? Silahkan mendaftar, sebagai
                <a href="vRegistrasi_Mahasiswa.php" style="color: #3366FF; text-decoration: none;">Mahasiswa</a> atau
                <a href="vRegistrasi_Dosen.php" style="color: #3366FF; text-decoration: none;">Dosen</a>
            </label>
        </div>
        <br>
        <div class="container" style="text-align: center;">
            <label style="font-size: 14px; font-family: 'Times New Roman', Times, serif; color: #555;">Lupa kata sandi?
                <a href="vReset_Password.php" style="color: #3366FF; text-decoration: none;">Reset kata sandi</a>
            </label>
        </div>
    </div>
